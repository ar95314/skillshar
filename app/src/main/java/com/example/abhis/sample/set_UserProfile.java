       ...
       mAuth = FirebaseAuth.getInstance();
        ...
        mAuthListener=new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser()!=null){
                    ...
                    String imgurltxt = getIntent().getExtras().getString("imgurl");
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            private void setUserProfile() {
               ...
               final String skill = skills.getText().toString().trim();
              final String experience = exp.getText().toString().trim();
              final String proj = project.getText().toString().trim();
                final String phonenumb=phone.getText().toString().trim();
                try{
                                ...
                                Uri downloadurl = taskSnapshot.getDownloadUrl();
                                            ...
                                            String userid = Objects.requireNonNull(mAuth.getCurrentUser()).getUid();
                                                   ...
                                                   currentuserdb.child("image").setValue(downloadurl.toString());
                                                    ...
                                                    Toast.makeText(set_UserProfile.this,"Success",Toast.LENGTH_LONG).show();
                                                    ...
                                                    Intent intent = new Intent(set_UserProfile.this, MainActivity.class);
