...
// Get the string array
            String[] categories = getResources().getStringArray(R.array.CategoriesFaagment_array);
// Create the adapter and set it to the AutoCompleteTextView
            ArrayAdapter<String> adapter =
                    new ArrayAdapter<String>(thiscontext, android.R.layout.simple_list_item_1, categories);
